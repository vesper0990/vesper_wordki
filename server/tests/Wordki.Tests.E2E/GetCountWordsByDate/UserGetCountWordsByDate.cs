...
{
    [TestFixture]
    public class UserGetCountWordsByDate : TestBase
    {
        public UserGetCountWordsByDate()
        {
            Request = new HttpRequestMessage(HttpMethod.Get, "getCountWordsByDate/2020-01-01");
        }
